...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        if (!pixelmonPresent) {
            getLogger().warning("Pixelmon not detected. Features require Pixelmon at runtime.");
        }

        if (getCommand("포켓사진") != null) {
            getCommand("포켓사진").setExecutor(new PocketPhotoCommand(this));
        }
